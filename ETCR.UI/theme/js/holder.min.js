          ...
          function (e) {
            ...
            for (; r < e.length; )
              (n = t.indexOf(e.charAt(r))),
                ...
                (o += 6),
                24 === o &&
                  (i.push(String.fromCharCode((a >> 16) & 255)),
                  i.push(String.fromCharCode((a >> 8) & 255)),
                  i.push(String.fromCharCode(255 & a)),
                  (o = 0),
                  (a = 0)),
                (r += 1);
            return (
              12 === o
                ? ((a >>= 4), i.push(String.fromCharCode(255 & a)))
                : 18 === o &&
                  ((a >>= 2),
                  i.push(String.fromCharCode((a >> 8) & 255)),
                  i.push(String.fromCharCode(255 & a))),
              ...
              for (; h < e.length; )
                (n = e.charCodeAt(h++)),
                  ...
                  h === e.length + 2
                    ? ((s = 64), (l = 64))
                    : h === e.length + 1 && (l = 64),
                  u.push(t.charAt(a), t.charAt(o), t.charAt(s), t.charAt(l));
              return u.join("");
            });
      })(e),
    ...
    return (function (e) {
        ...
        (function (t) {
          ...
          function a(e) {
            ...
            var b = {
              mode: t,
              el: n,
              holderSettings: { dimensions: a, theme: s, flags: r },
              engineSettings: v,
            };
            "image" == t
              ? (r.auto ||
          ...
          function o(e) {
            ...
            "background" == i
              ? ((a.style.backgroundImage = "url(" + r + ")"),
                l.noBackgroundSize ||
                  (a.style.backgroundSize = h.width + "px " + h.height + "px"))
              : ("img" === a.nodeName.toLowerCase()
                  ? x.setAttr(a, { src: r })
                  : "object" === a.nodeName.toLowerCase() &&
                    x.setAttr(a, { data: r, type: "image/svg+xml" }),
                l.reRender &&
                  t.setTimeout(function () {
                    ...
                    "img" === a.nodeName.toLowerCase()
                      ? x.setAttr(a, { src: e })
                      : "object" === a.nodeName.toLowerCase() &&
                        x.setAttr(a, { data: e, type: "image/svg+xml" });
                  }, 150)),
              x.setAttr(a, { "data-holder-rendered": !0 });
          }
          function s(e) {
            function t(e, t, n, r) {
              (t.width = n),
            ...
            var r = e.flags.lineWrap || O.setup.lineWrapRatio,
              i = e.width * r,
              a = i,
              o = new y({ width: e.width, height: e.height }),
              s = o.Shape,
            ...
            for (var n = 0, r = t.length; r > n; n++) {
              ...
              if (i.holderData) {
                ...
                if (s) {
                  ...
                  var h = {
                    mode: "image",
                    holderSettings: { dimensions: s, theme: a.theme, flags: a },
                    el: i,
                    engineSettings: i.holderData.engineSettings,
                  };
                  "exact" == a.textmode &&
                    ((a.exactDimensions = s),
                    (h.holderSettings.dimensions = a.dimensions)),
                    o(h);
                } else f(i);
              }
            }
            ...
            j = {
              ...
              run: function (e) {
                ...
                var n = {},
                  o = T(O.settings, e);
                (O.vars.preempted = !0),
                  (O.vars.dataAttr = o.dataAttr || O.setup.dataAttr),
                  (n.renderer = o.renderer ? o.renderer : O.setup.renderer),
                  -1 === O.setup.renderers.join(",").indexOf(n.renderer) &&
                ...
                return (
                  ...
                  (n.noFontFallback = !!o.noFontFallback),
                  (n.noBackgroundSize = !!o.noBackgroundSize),
                  ...
                  u.forEach(function (e) {
                    ...
                    var a = null != t.data && 0 === t.data.indexOf(o.domain),
                      s =
                        null != t.dataSrc && 0 === t.dataSrc.indexOf(o.domain);
            ...
            z = (function () {
              ...
              return function (r) {
                ...
                if (O.setup.supportsSVG) {
                  ...
                  (null == e || e.parentNode !== document.body) && (a = !0),
                  ...
                  if (d > 1) {
                    ...
                    for (var y = 0; y < c.length; y++)
                      if (0 !== c[y].length) {
                        ...
                        var S = t.getBBox();
                        v.push({ text: c[y], width: S.width });
                      }
                  }
                  return (
                    (e.style.display = "none"),
                    { spaceWidth: m, lineCount: d, boundingBox: u, words: v }
                  );
                }
                return !1;
              };
      ...
      function (e, t) {
        var n = function (e) {
          ...
          var h = new i();
          return (
            (this.Shape = { Rect: s, Text: l, Group: o }), (this.root = h), this
          );
        };
        e.exports = n;
      },
          ...
          (t.extend = function (e, t) {
            ...
            (t.parseColor = function (e) {
              var t,
                ...
                a = e.match(n);
              if (null !== a)
                return (t = a[1] || a[2]), "#" !== t[0] ? "#" + t : t;
              if (((a = e.match(r)), null !== a))
                return (t = "rgb(" + a.slice(1).join(",") + ")");
        ...
        (n.rgb2hex = function (e, t, n) {
          ...
          (n.prototype.set = function (e) {
            ...
            var t = (16711680 & this.raw) >> 16,
              ...
              a = -0.09991 * t - 0.33609 * n + 0.436 * r,
              o = 0.615 * t - 0.55861 * n - 0.05639 * r;
            return (
              (this.rgb = { r: t, g: n, b: r }),
              (this.yuv = { y: i, u: a, v: o }),
              this
            );
          }),
      ...
      function (e, t) {
        e.exports = { version: "2.9.7", svg_ns: "http://www.w3.org/2000/svg" };
      },
      function (e, t, n) {
        function r(e, t) {
          return d.element({
        ...
        e.exports = function r(e, t, n) {
          ...
          function i(e) {
            ...
            return (
              ...
              a && (n[a[1]] = r),
              o && (r.attr["class"] = o.join(" ").replace(/\./g, "")),
              e.match(/&$/g) && (f = !1),
              r
            );
          }
      ...
      function (e, t, n) {
        ...
        e.exports = (function () {
          ...
          return function (n) {
            ...
            var r = i.canvasRatio(),
              a = n.root;
            (e.width = r * a.properties.width),
              (e.height = r * a.properties.height),
            ...
            var o = a.children.holderBg,
              ...
              h = 2,
              u = h / 2;
            (t.fillStyle = o.properties.fill),
              t.fillRect(0, 0, s, l),
              o.properties.outline &&
                ((t.strokeStyle = o.properties.outline.fill),
                (t.lineWidth = o.properties.outline.width),
                t.moveTo(u, u),
                t.lineTo(s - u, u),
                t.lineTo(s - u, l - u),
                t.lineTo(u, l - u),
